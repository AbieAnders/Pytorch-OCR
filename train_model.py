#set TF_ENABLE_ONEDNN_OPTS=0 , use this in cmd.
...
'''if torch.cuda.is_available():
    # Set the device to the first AMD GPU
    device = torch.device("cuda:0")
    print("Using AMD GPU for computation")
else:
    device = torch.device("cpu")
    print("CUDA (ROCM) is not available. Using CPU for computation")
